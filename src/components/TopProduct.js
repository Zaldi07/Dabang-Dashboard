          ...
          <div className="   ">
            <div className="flex flex-col pt-2 ">
              ...
              <div className="flex w-full my-1 border-b ">
                <h1 className="text-[#444A6D] lg:py-4 pt-4 w-[10%] pl-3 text-sm">01</h1>
                <h1 className="text-[#444A6D] lg:py-4 pt-10   w-[40%] text-sm">Home Decor Range</h1>
              ...
              <div className="flex w-full my-1 border-b ">
                <h1 className="text-[#444A6D] lg:py-4 pt-4 w-[10%] pl-3 text-sm">02</h1>
                <h1 className="text-[#444A6D] lg:py-4 pt-10  w-[40%] text-sm">Disney Princess Pink</h1>
                <div className="w-[30%] relative pt-6">
              ...
              <div className="flex w-full my-1 border-b ">
                <h1 className="text-[#444A6D] lg:py-4 pt-4 w-[10%] pl-3 text-sm">03</h1>
                <h1 className="text-[#444A6D] lg:py-4 pt-10  w-[40%] text-sm">Bathroom Essentials</h1>
                <div className="w-[30%] relative pt-6">
              ...
              <div className="flex w-full ">
                <h1 className="text-[#444A6D] lg:py-4 pt-4 w-[10%] pl-3 text-sm">04</h1>
                <h1 className="text-[#444A6D] lg:py-4 pt-10  w-[40%] text-sm">Apple Smartwatches</h1>
                <div className="w-[30%] relative pt-6">
